...
de_avg = germany$de_avg
figure_1b = ggplot() + 
  geom_line(data = de_avg, aes(x = date, y = avg_new_cases_glm_time_residuals, color = "Daily new cases, residuals")) +
  geom_point(data = de_avg, aes(x = date, y = avg_new_cases_glm_time_residuals, color = "Daily new cases, residuals")) +
  geom_vline(xintercept = as.POSIXct("2020-03-14"), linetype="dotted", color = "black") +
  geom_vline(xintercept = as.POSIXct("2020-03-17"), linetype="dotted", color = "black") +
