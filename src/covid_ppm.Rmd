...
pm_stations= st_as_sf(rbindlist(pm, fill = TRUE)) 
mapview(pm_stations, zcol = "pm25")     
...
fig = plot_ly() %>% add_trace(data = pm_stations, x = ~date, y = ~pm25, color = ~statname, type = 'scatter', mode = 'lines+markers')
