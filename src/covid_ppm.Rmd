...
## Mean development of PM2.5 and COVID-19 cases in 
...
ggplot() + 
  geom_line(data = nuts3_mean_avg, aes(x = date, y = pm25_mean, color = "red")) + 
  geom_line(data = nuts3_mean_avg, aes(x = date, y = new_cases_smooth, color = "blue")) + 
