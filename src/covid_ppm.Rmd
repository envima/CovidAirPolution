...
if(Sys.info()[["nodename"]] == "PC19616"){
  ...
  source("~/project/cov/CovidAirPolution/CovidAirPolution/src/functions/000_setup.R")  
}
...
# merge data colums
bergamo = merge(x = cov_it$cov_admin3[cov_it$cov_admin3$denominazione_provincia == "Bergamo", ], 
               y = pm25[[8]], 
               by.x = "data", by.y = "date", sort = T)
head(bergamo)
...
Die nachfolgenden Abbildung zeigen die wavelet Analyse der PEriodizität der neuen Corona Fälle in Bergamo
...
bergamo.w  =  analyze.wavelet(bergamo, "new_cases",
                              ...
                              lowerPeriod = 1, upperPeriod = 28, make.pval = TRUE, 
                              n.sim = 10)
