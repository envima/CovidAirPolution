...
de_cmpldata <- lapply(pm_vars, function(pm) {
  ...
  return(readRDS(file.path(envrmt$path_analysis, de_cmpldata_file)))
})
...
cntry_indv <- de_cmpldata$PM10$de_clstr$clstr
...
cntry_indv <- de_cmpldata$PM2.5$de_clstr$clstr
...
de_model_figure_cumulative_effect$PM10$de_lm_tavrg_smry
signif(de_model_figure_cumulative_effect$PM10$de_lm_tavrg_smry$coefficients, 3)
de_model_figure_cumulative_effect$PM10$de_lm_tavrg_stpAIC_smry
```
...
de_model_figure_cumulative_effect$PM10$de_lm_tavrg_stpAIC_smry
signif(de_model_figure_cumulative_effect$PM10$de_lm_tavrg_stpAIC_smry$coefficients, 3)
```
...
de_model_figure_cumulative_effect$PM2.5$de_lm_tavrg_smry
signif(de_model_figure_cumulative_effect$PM2.5$de_lm_tavrg_smry$coefficients, 3)
```
...
de_model_figure_cumulative_effect$PM2.5$de_lm_tavrg_stpAIC_smry
signif(de_model_figure_cumulative_effect$PM2.5$de_lm_tavrg_stpAIC_smry$coefficients, 3)
