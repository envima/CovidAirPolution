...
figure_cntry_avg <- readRDS(file.path(envrmt$path_figures, "germany_figure_cntry_avg.rds"))
figure_gam_lag_set <- readRDS(file.path(envrmt$path_figures, "germany_figure_gam_lag_set.rds"))
figure_gam_lag_mixed_set <- readRDS(file.path(envrmt$path_figures, "germany_figure_gam_lag_mixed_set.rds"))
model_figure_cumulative_effect <- readRDS(file.path(envrmt$path_figures, "germany_model_figure_cumulative_effect.rds"))
map_covid_infections <- readRDS(file.path(envrmt$path_figures, "germany_map_covid_infections.rds"))
map_pm_mean <- readRDS(file.path(envrmt$path_figures, "germany_map_pm_mean.rds"))
lm_tavrg_smry <- readRDS(file.path(envrmt$path_figures, "germany_lm_tavrg_smry.rds"))
lm_tavrg_stpAIC_smry <- readRDS(file.path(envrmt$path_figures, "germany_lm_tavrg_stpAIC_smry.rds"))
cor_figure_corr_PM10_PM2.5 <- readRDS(file.path(envrmt$path_figures, "germany_cor_figure_corr_PM10_PM2.5.rds"))
excluded_data_PM10 <- readRDS(file.path(envrmt$path_analysis, "germany_PM10_non_valid.rds"))
excluded_data_PM2.5 <- readRDS(file.path(envrmt$path_analysis, "germany_PM2.5_non_valid.rds"))
...
cntry_indv <- cmpldata$PM10$de_clstr$clstr
...
cntry_indv <- cmpldata$PM2.5$de_clstr$clstr
...
ggsave(file.path(envrmt$path_figures, "germany_figure_1.png"),
  plot = figure_1,
...
# Fig. 2: Country wide SARS-CoV-2 infection models.
...
ggsave(file.path(envrmt$path_figures, "germany_figure_2.png"),
  plot = figure_2,
  width = 347, height = 450, units = "mm", dpi = 300
)
```
...
# Figure: Country wide SARS-CoV-2 infections and PM10 concentrations.

```{r, eval = TRUE, echo=FALSE, message=FALSE, warning=FALSE, results = FALSE}

figure <- plot_grid(figure_1, figure_2, labels = NULL, ncol = 2)
ggsave(file.path(envrmt$path_figures, "germany_figure.png"),
  plot = figure,
...
ggsave(file.path(envrmt$path_figure, "germany_figure_s1.png"),
  plot = figure_sup_1,
  width = 347, height = 450, units = "mm", dpi = 300
)
```
...
ggsave(file.path(envrmt$path_figures, "germany_figure_s2.png"),
  plot = figure_sup_2,
  width = 347, height = 450, units = "mm", dpi = 300
)
```
...
ggsave(file.path(envrmt$path_figures, "germany_figure_s3.png"),
  plot = figure_sup_3,
  width = 347, height = 450, units = "mm", dpi = 300
)
```
