...
ggplot() + 
  ...
  geom_line(data = de_avg, aes(x = date, y = new_cases_loess, color = "New cases smoothed")) + 
  geom_line(data = de_avg, aes(x = date, y = avg_new_cases_glm_time_residuals, color = "New cases GLM smoothed")) + 
...
ggplot() + 
  geom_line(data = de_avg, aes(x = date, y = new_cases, color = "New cases")) + 
  geom_line(data = de_avg, aes(x = date, y = avg_new_cases_glm_time, color = "New cases GLM")) + 
  geom_line(data = de_avg, aes(x = date, y = avg_new_cases_glm_time_residuals, color = "New cases GLM residuals")) + 
...
ggplot() + 
  geom_line(data = de_clstr$clstr_avg_pm_glm_time, aes(x = date, y = pm_mean, color = "PM")) + 
  geom_line(data = de_clstr$clstr_avg_pm_glm_time, aes(x = date, y = new_cases, color = "New cases")) + 
  geom_line(data = de_clstr$clstr_avg_pm_glm_time, aes(x = date, y = new_cases_glm_time, color = "New cases (smoothed, detrended)")) +
  geom_vline(xintercept = as.POSIXct("2020-03-14"), linetype="dotted", color = "black") +
  geom_vline(xintercept = as.POSIXct("2020-03-17"), linetype="dotted", color = "black") +
  theme_bw() + 
  labs(title = paste(pm, " x daily new Covid-19 cases (smoothed, detrended)"), x = "Date", y = "Value") +
...
ggplot() + 
  ...
  geom_line(data = tmp, aes(x = date, y = predicted, color = "Daily new cases, predicted")) +
  geom_point(data = tmp, aes(x = date, y = predicted, color = "Daily new cases, predicted")) +
...
# de_model_lag_c = compileLaggedGLM(data = de_clstr,  
#                                 pm = "org", 
#                                 frml = "cases ~ date + weekday + pm_mean_lag",
#                                 nlags = 20,
#                                 subset_var = "new_cases", subset_thv = 1, individual = "start", ndays = c(0, 30))
# 
# 
# de_model_lag = de_model_lag_nc
# de_model_lag = de_model_lag_c

de_model_geo = compileLaggedGLMGeo(de_model_lag, germany$de_nuts3_map)

for(i in seq(0, -20)){
  print(i)
  print(t.test(de_model_lag$t[de_model_lag$lag == i]))
}
