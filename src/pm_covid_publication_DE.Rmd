...
ggplot() + 
  ...
  theme(axis.text.x = element_text(angle=90)) + 
  theme(legend.title = element_blank()) +
  facet_wrap(~cluster_covid, ncol =2, nrow = 2, scales = "fix")
```
...
de_model_lag = compileLaggedGLM(de_clstr, individual = TRUE)
