...
if (compile_models) {
  ...
  saveRDS(gam_lag, file.path(envrmt$path_analysis, paste0("gam_lag_", lag_var, "_", pm, ".rds")))
} else {
  gam_lag <- readRDS(file.path(envrmt$path_analysis, paste0("gam_lag_", lag_var, "_", pm, ".rds")))
}
...
if (compile_models) {
  ...
  saveRDS(gam_lag_mixed, file.path(envrmt$path_analysis, paste0("gam_lag_mixed_", mlm, "_", lag_var, "_", pm, ".rds")))
} else {
  gam_lag_mixed <- readRDS(file.path(envrmt$path_analysis, paste0("gam_lag_mixed_", mlm, "_", lag_var, "_", pm, ".rds")))
}
