...
# "LK Böblingen"  "LK Breisgau-Hochschwarzwald" "LK Erzgebirgskreis"
# "LK Esslingen"  "LK Ludwigsburg"  "LK Mansfeld-Südharz"  "LK Nordfriesland"
# "LK Oberhavel"  "LK Schwarzwald-Baar-Kreis"  "LK Uelzen"
# "SK Freiburg i.Breisgau"  "SK Heidelberg"  "SK Heilbronn"  "SK Pforzheim"
```
...
gam_lag_mixed <- compileLaggedGAM(
  data = cntry_indv, pm = "org",
  frml = 'new_cases ~ s(date_seq) + weekday + pm_median_lag + s(nuts3CodeFactor, bs="re")',
  nlags = 15,
  subset_var = "new_cases", subset_thv = 10, individual = "start", ndays = c(0, 30),
...
# Meta-analysis of correlation between PM and SARS-CoV2 infections
...
# Test of the slope between population and SARS-CoV2 infections
t <- lm(cases_log10 ~ pop_total_log10, offset = pop_total_log10, data = cntry_agg)
summary(t)



# Test of the long-term correlation between PM and SARS-CoV2 infections
lm_tavrg <- lm(cases_log10 ~ centroid_lat + centroid_lon + pop_total_log10 + st_area_log10 +
  difftime_first_shutdown + PM_tavrg_log10, data = cntry_agg)

summary(lm_tavrg)
summary(stepAIC(lm_tavrg))
