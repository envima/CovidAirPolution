...
de_clstr = lapply(unique(de_clstr$nuts3Code), function(n){
...
de_model_lag = compileLaggedGLM(data = de_clstr,  
                                pm = "org", 
                                frml = "new_cases ~ date_numeric + weekday_c + pm_mean_lag",
                                nlags = 40,
                                min_cases = 1, individual = TRUE, ndays = c(-10, 15))

# de_model_lag = compileLaggedGAM(data = de_clstr,
#                                 target = "new_cases", nlags = 20,
#                                 min_cases = 1, individual = TRUE, ndays = c(0, 40))
