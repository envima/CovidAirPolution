...
if(compile_data){
  ...
  de_avg = compileAvg(germany$de_nuts3)
  de_clstr = compileDTW(germany$de_nuts3)
...
```{r, eval = TRUE, echo=FALSE, message=FALSE, warning=FALSE, results = FALSE}
de_clstr = germany$de_clstr
de_model_lag = compileLaggedGLM(de_clstr$de_clstr_indv)
```
...
```{r, eval = TRUE, echo=FALSE, message=FALSE, warning=FALSE, results = FALSE}
de_model_geo = compileLaggedGLMGeo(de_model_lag, de_nuts3_map)
